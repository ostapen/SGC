...
adj, train_adj, val_adj, features, labels, idx_train, idx_val, idx_test = load_citation(args.dataset, args.normalization, args.cuda)
...
if args.model == "SGC":
    ...
    acc_test = test_regression(model, test_features, labels[idx_test])
